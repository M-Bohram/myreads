    ...
    return (
      <div className="list-books">
        ...
        <div className="list-books-content">
          <div>
            <BookShelf
              books={this.state.shelfs[0].books}
              title={this.state.shelfs[0].title}
            />
            <BookShelf
              books={this.state.shelfs[1].books}
              title={this.state.shelfs[1].title}
            />
            <BookShelf
              books={this.state.shelfs[2].books}
              title={this.state.shelfs[2].title}
            />
          </div>
        </div>
